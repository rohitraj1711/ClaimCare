    ...
    try {
      ...
      if (isEditing) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: const Text('Claim updated successfully'),
                    ...
                    _buildSection(
                      ...
                      children: [
                        _buildTextField(
                          ...
                          label: 'Hospital Name',
                          hint: 'Name of the treating hospital',
                        ...
                        if (isMobile) ...[
                          _buildDateField(
                            ...
                            onSelect: (date) {
                              setState(() {
                                _admissionDate = date;
                                if (_dischargeDate != null && _dischargeDate!.isBefore(date)) {
                                  _dischargeDate = null;
                                }
                              });
                            },
                          ...
                          _buildDateField(
                            ...
                            onSelect: (date) => setState(() => _dischargeDate = date),
                            onClear: () => setState(() => _dischargeDate = null),
                          ),
                        ] else
                          Row(
                            children: [
